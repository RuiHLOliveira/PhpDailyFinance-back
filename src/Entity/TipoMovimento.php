 ...
 */
class TipoMovimento implements JsonSerializable
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=User::class, inversedBy="tipoMovimentos")
     * @ORM\JoinColumn(nullable=false)
     */
    private $usuario;

    /**
     * @ORM\OneToMany(targetEntity=Movimento::class, mappedBy="tipomovimento")
     */
    private $movimentos;
    ...
    public function removeMovimento(Movimento $movimento): self
    {
        if ($this->movimentos->removeElement($movimento)) {
            ...
            if ($movimento->getTipomovimento() === $this) {
